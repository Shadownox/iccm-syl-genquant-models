...
class PHM():
    def __init__(self, khemlani_phrase=False):
        ...
        self.informativeness_order = ['A', 'T', 'D', 'I', 'E', 'O']
        self.p_entailments = {'A': 'I', 'E': 'O', 'O': 'I', 'I': 'O', 'T': 'I', 'D': 'O'}
    ...
    def max_heuristic(self, task, a_conf, t_conf, i_conf, e_conf, d_conf, o_conf):
        """
