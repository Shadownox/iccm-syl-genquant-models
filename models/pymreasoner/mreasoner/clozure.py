...
DL_URLS = {
    'Darwin': 'https://github.com/Clozure/ccl/releases/download/v1.12.1/ccl-1.12.1-darwinx86.tar.gz',
    'Windows': 'https://github.com/Clozure/ccl/releases/download/v1.12.1/ccl-1.12.1-windowsx86.zip',
    'Linux': 'https://github.com/Clozure/ccl/releases/download/v1.12.1/ccl-1.12.1-linuxx86.tar.gz'
}
